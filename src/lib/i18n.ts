...
const pt = {
  ...
  app: {
    ...
    create: {
      ...
      from: 'Da seção',
      to: 'Até a seção',
      sliceHint: 'Opcional, mas recomendado: recorta o extrato em vez de mandar o livro inteiro.',
      language: 'Idioma do conteúdo',
      family: 'Área',
      pdf: 'PDF do livro',
      questions: 'Banco de questões',
      questionsHint: 'Opcional. Se você anexar, a saída vira um exam review organizado por questão — e consome 2 créditos.',
      cost: 'Custo',
      credit: 'crédito',
      creditsPl: 'créditos',
      submit: 'Gerar guia',
    ...
    material: {
      ...
      stages: { pending: 'Na fila', extracting: 'Extraindo o texto', planning: 'Planejando os blocos', generating: 'Escrevendo', rendering: 'Renderizando o PDF', validating: 'Validando', done: 'Pronto', failed: 'Falhou' },
    },
  },
  types: { pocket_guide: 'Guia de bolso', exam_review: 'Exam review' },
  languages: { bilingual: 'Bilíngue', en: 'Inglês', pt: 'Português' },
  families: { deep_learning: 'Deep Learning', supervised: 'ML supervisionado', unsupervised: 'Não supervisionado', foundations: 'Fundamentos' },
}
...
const en: Dict = {
  ...
  app: {
    ...
    create: {
      ...
      from: 'From section',
      to: 'To section',
      sliceHint: 'Optional but recommended: it slices the extract instead of sending the whole book.',
      language: 'Content language',
      family: 'Field',
      pdf: 'Source PDF',
      questions: 'Question bank',
      questionsHint: 'Optional. Attach one and the output becomes a question-first exam review, which costs 2 credits.',
      cost: 'Cost',
      credit: 'credit',
      creditsPl: 'credits',
    ...
    material: {
      ...
      stages: { pending: 'Queued', extracting: 'Extracting the text', planning: 'Planning the blocks', generating: 'Writing', rendering: 'Rendering the PDF', validating: 'Validating', done: 'Ready', failed: 'Failed' },
    },
  },
  types: { pocket_guide: 'Pocket guide', exam_review: 'Exam review' },
  languages: { bilingual: 'Bilingual', en: 'English', pt: 'Portuguese' },
  families: { deep_learning: 'Deep Learning', supervised: 'Supervised ML', unsupervised: 'Unsupervised', foundations: 'Foundations' },
}
