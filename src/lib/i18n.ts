...
const pt = {
  ...
  app: {
    nav: { overview: 'Visão geral', create: 'Novo guia', history: 'Histórico', credits: 'Créditos', audit: 'Auditoria', logout: 'Sair' },
    greeting: 'Olá',
    audit: {
      title: 'Auditoria',
      ...
      events: {
        ...
        generate: 'Gerou guia', derive: 'Conjunto de estudo', refund: 'Estorno', grant: 'Crédito concedido',
...
const en: Dict = {
  ...
  app: {
    nav: { overview: 'Overview', create: 'New guide', history: 'History', credits: 'Credits', audit: 'Audit', logout: 'Sign out' },
    greeting: 'Hello',
    audit: {
      title: 'Audit',
      ...
      events: {
        ...
        generate: 'Generated guide', derive: 'Study set', refund: 'Refund', grant: 'Credits granted',
      } as Record<string, string>,
    },
    overview: {
      title: 'Overview',
