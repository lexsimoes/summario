  ...
  app: {
    ...
    material: {
      ...
      study: {
        ...
        lede: 'Quiz de recuperação, flashcards e ideias de projeto tirados deste guia. Incluído em todos os guias, sem consumo adicional.',
...
const en: Dict = {
  ...
  app: {
    ...
    material: {
      ...
      study: {
        title: 'Study set',
        lede: 'A retrieval quiz, flashcards and project ideas drawn from this guide. Included with every guide at no additional cost.',
